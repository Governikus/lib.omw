...
public final class OMAPITP implements TransportProvider {
    ...
    /**
     * Create an OMAPI wrapper transport provider for an OMAPI channel.
     *
     * @param channel
     */
    ...
    /**
     * Create an OMAPI wrapper transport provider on top of some physical transport layer.
     *
     * @param seTP
     */
...
//                        }
    ...
    public interface CallbackHandler {
        ...
        /**
         * Request user authentication and request the secret
         * TODO: maybe extend as getString(String realm) giving it a name, i.e. SE slot and applet ID
         *
         * @return plain authentication secret
         */
        byte[] getSecret();
    }
}
